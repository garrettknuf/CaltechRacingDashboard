...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(SEGDISP_SCL_GPIO_Port, SEGDISP_SCL_Pin);

    HAL_GPIO_DeInit(SEGDISP_SDA_GPIO_Port, SEGDISP_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE14     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, DISP_SCK_Pin|DISP_MISO_Pin|DISP_MOSI_Pin);
